...
To support the editors in creating and maintaining data specifications ([*](./glossary.md#data_spec), [**](./glossary.md#sem_web), [***](./glossary.md#reg_test), [****](./glossary.md#cd_ci), [*****](./glossary.md#shacl), [******](./glossary.md#xsd), [******](./glossary.md#json_ld))in a coherent manner, tooling is required.
